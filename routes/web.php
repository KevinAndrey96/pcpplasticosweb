...
Route::post('/chooseListUser', [App\Http\Controllers\UsersController::class, 'chooseListUser'])->middleware('auth');
Route::post('importUsers', [App\Http\Controllers\UsersController::class, 'importUsers'])->middleware('auth');
...
Route::get('/detailMyOrder', [App\Http\Controllers\OrderProductsController::class, 'detailMyOrder'])->middleware('auth');
Route::post('/changeStatus', [App\Http\Controllers\OrderProductsController::class, 'changeStatus'])->middleware('auth');
Route::post('/downloadPDF', [App\Http\Controllers\OrderProductsController::class, 'downloadPDF'])->middleware('auth');
Route::get('/myOrders', [App\Http\Controllers\OrderProductsController::class, 'myOrders'])->middleware('auth');
Route::post('/quotation', [App\Http\Controllers\OrderProductsController::class, 'quotation'])->middleware('auth');
Route::get('/ironAsoc', [App\Http\Controllers\UsersController::class, 'ironAsoc'])->middleware('auth');
Route::get('/allTransfers', [App\Http\Controllers\OrderProductsController::class, 'allTransfers'])->middleware('auth');
Route::get('/orderReturn', [App\Http\Controllers\OrderProductsController::class, 'orderReturn'])->middleware('auth');
