...
<body id="page-top">
    ...
    <div id="wrapper" >
        ...
        <ul style="background:#2ab2e2" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" @if(Auth::user()->role == 'Distribuidor' || Auth::user()->role == 'Ferretero' ) href="/home" @else href="/users?role=all" @endif>
               <img src="/assets/images/pcp2.png" width="50px" >
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('/showOrders?role=Administrador') }}">Ver pedidos</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/allTransfers">Ver transferencias</a>
                    </div>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/home" data-target="#collapsePages1"
                    aria-expanded="true" aria-controls="collapsePages">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" target="_blank"href="https://nueva.pcpplasticos.co/wp-content/uploads/2021/04/CATALOGO_COLOMBIA.pdf" data-target="#collapsePages1"
                    aria-expanded="true" aria-controls="collapsePages">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" target="_blank" href="https://nueva.pcpplasticos.co/quienes-somos/" data-target="#collapsePages1"
                    aria-expanded="true" aria-controls="collapsePages">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" target="_blank" href="https://nueva.pcpplasticos.co/blog/" data-target="#collapsePages1"
                    aria-expanded="true" aria-controls="collapsePages">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" target="_blank" href="https://nueva.pcpplasticos.co/contacto/" data-target="#collapsePages1"
                    aria-expanded="true" aria-controls="collapsePages">
    ...
    <script>
        /*
        $boton_submit = document.getElementById('form-continue');
        console.log($boton_submit);

        $('#form-continue').submit(function(e){
            e.preventDefault();
            swal("Hello world!");
        });
*/
