                ...
                <tr>
                    ...
                    <td style="text-align: center;" >
                        <div class="row">
                            ...
                            <a href="{{url('exportProducts/'.$list->id)}}" class = "btn btn-secondary form-control" title="Exportar lista"  style="margin:3px; width:40px;"><i class="fas fa-file-import"></i></a>
    
                            
                                <a href="{{ url('/chooseList?id=').$list->id }}" class = "btn btn-info form-control" title="Importar lista" style="margin:3px; width:40px;"><i class="fas fa-file-upload"></i></a>
