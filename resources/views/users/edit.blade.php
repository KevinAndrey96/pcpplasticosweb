  ...
  <form action="{{url('/users/'.$user->id)}}" method="POST" enctype="multipart/form-data"> 
    ...
    <div class="form-group">
      ...
      <select class="form-control" name="document_type">
        <option value="{{ $user->document_type }}" selected disabled>{{ $user->document_type }}</option>
    ...
    <div class="form-group">
      ...
      <input class="form-control" type="text" name="document_number" id="document_number" value="{{ $user->document_number }}">
    </div>
    <div class="form-group">
